...
const GradBroCreditIcon = () => {
  return (
    <svg
      className="grad-bro-credit-icon"
      version="1.1"
      id="_x35_"
    ...
    >
      <g>
       ...
       c3.428,3.411,5.605,8.073,5.776,13.214C275.71,150.944,275.71,151.167,275.71,151.407z"
            ...
            <path
              style={{ fill: "#FFFFFF" }}
              d="M275.71,241.662v40.054c-2.108-0.48-4.61-0.943-7.524-1.371l-25.897-3.959
       c-2.074-0.309-4.062-0.651-5.999-1.028v-42.351c1.165,0.703,2.399,1.354,3.719,1.936c3.154,1.423,7.061,2.451,11.723,3.051
       L275.71,241.662z"
            />
            <path
              style={{ fill: "#FFFFFF" }}
              d="M255.692,332.739c7.867,0,14.534-0.874,20.018-2.639v38.974c0,10.832-8.861,19.71-19.71,19.71
       ...
       c3.428,3.411,5.605,8.072,5.776,13.214C275.71,146.704,275.71,146.927,275.71,147.167z"
            ...
            <path
              style={{ fill: "#CC9322" }}
              d="M275.71,237.421v40.054c-2.108-0.48-4.61-0.943-7.524-1.371l-25.897-3.959
       c-2.074-0.309-4.062-0.651-5.999-1.028v-42.351c1.165,0.703,2.399,1.354,3.719,1.936c3.154,1.423,7.061,2.451,11.723,3.051
       L275.71,237.421z"
            />
            <path
              style={{ fill: "#CC9322" }}
              d="M255.692,328.498c7.867,0,14.534-0.874,20.018-2.639v38.974c0,10.832-8.861,19.71-19.71,19.71
          ...
          {isUserLoggedIn ? (
            <>
              ...
              <NavDropdown
                ...
                id="logout-dropdown"
                align="end" // This aligns the dropdown to the left side
              >
